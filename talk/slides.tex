...
\begin{frame}
  \frametitle{Chain properties}
  \begin{itemize}
  \item Outer edge \(e'\) determines the maximal chain \(C_{e'}\).
    \pause
  \item Edges of \(C_{e'}\) can be partitioned into two sets: \(S_{e'}\) and \(L_{e'}\).
  \item Graph \(G\) can be decomposed into a tree of chains.
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Chain properties: \(S_{e'}\) and \(L_{e'}\)}
...
\begin{frame}
  \frametitle{Chain properties: decomposition}
  ...
  \begin{figure}
    \begin{tikzpicture}[scale=1,auto,swap]
      ...
      \node[vertex] (2) at (-5, 0)     {};
      \node[vertex] (9) at (-3, 0)     {};
      \node[vertex] (10) at (-4, -1.73) {};
      \node[vertex] (3) at (-1, 0)     {};
      \node[vertex] (4) at ( 1, 0)     {};
      \node[vertex] (5) at ( 3, 0)     {};
      \node[vertex] (6) at (-2, -1.73) {};
      \node[vertex] (7) at ( 0, -1.73) {};
      \node[vertex] (8) at ( 5, -1.73) {};
      \node[vertex] (11) at (4, 0)     {};
      \node[vertex] (12) at (6, 0)     {};
...
\begin{frame}
  \frametitle{Possible chains}

  \begin{itemize}
  \item Single triangle.
  \item Positive sequence.
  \item Positive and negative sequence.
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Possible chains: single triangle}

  \begin{figure}
    \begin{tikzpicture}[scale=0.5,auto,swap]
      \node[fvertex] (0) at (0, -0.7)   {\(v_{0}^{-}\)};
      \node[fvertex] (1) at (-3, 4.7)   {\(v_{0}^{+}\)};
      \node[fvertex] (2) at (-0.3, 3.2) {\(v_{1}\)};

      \node[vertex] (10) at (0, 0)       {};
      \node[vertex] (11) at (-3, 4)      {};
      \node[vertex] (12) at (-0.6, 2.7)  {};
      ...
      \draw[dedge] (2,7) -- node[swap]{\(\vec{\bf{d}}\)} (7, 7);
...
\begin{frame}
  \frametitle{Possible chains: positive sequence}
  ...
  \begin{figure}
    \begin{tikzpicture}[scale=0.5,auto,swap]
      ...
      \node[fvertex] (1) at (-3, 4.7)   {\(v_{0}^{+}\)};
      \node[fvertex] (2) at (-0.3, 3.2) {\(v_{1}\)};
      \node[fvertex] (3) at ( 2, 4.5)   {\(v_{2}\)};
      \node[fvertex] (4) at (4.4, 3.2)  {\(v_{3}\)};
      \node[fvertex] (5) at (7, 4.5)    {\(v_{4}\)};
      \node[fvertex] (6) at (9.4, 3.2)  {\(v_{5}\)};
      \node[fvertex] (7) at (12, 4.5)   {\(v_{6}\)};
      \node[fvertex] (8) at (14.4, 3.2) {\(v_{7}\)};

      \node[vertex] (20) at (0, 0)       {};
      \node[vertex] (21) at (-3, 4)      {};
      \node[vertex] (22) at (-0.6, 2.7)  {};
      \node[vertex] (23) at (2, 4)       {};
      \node[vertex] (24) at (4.4, 2.7)   {};
      \node[vertex] (25) at (7, 4)       {};
      \node[vertex] (26) at (9.4, 2.7)   {};
      \node[vertex] (27) at (12, 4)      {};
      \node[vertex] (28) at (14.4, 2.7)  {};
      ...
      \path[edge] (0, 0)  -- (-3, 4);
      \path[edge] (0, 0)  -- (15.5, 0);
      \path[edge] (-3, 4) -- (15.5, 4);
    \end{tikzpicture}
  \end{figure}  
\end{frame}

\begin{frame}
  \frametitle{Possible chains: positive and negative sequences}
  ...
  \begin{figure}
    \begin{tikzpicture}[scale=0.5,auto,swap]
      ...
      \node[fvertex] (10) at (5 , -0.7) {\(v_{-2}\)};
      \node[fvertex] (11) at (10, -0.7) {\(v_{-4}\)};
      \node[fvertex] (12) at (15, -0.7) {\(v_{-6}\)};

      \node[fvertex] (13) at (5.2, 2)  {\(v_{-1}\)};
      \node[fvertex] (14) at (10.2, 2)  {\(v_{-3}\)};
      \node[fvertex] (15) at (15.2, 2) {\(v_{-5}\)};
      ...
      \node[vertex] (29) at (5, 0)  {};
      \node[vertex] (30) at (10, 0) {};
      \node[vertex] (31) at (15, 0) {};
